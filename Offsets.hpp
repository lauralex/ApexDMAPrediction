...
// Core
constexpr uint64_t OFF_LEVEL = 0x1a53ba0;                         //[Miscellaneous]->LevelName
constexpr uint64_t OFF_LOCAL_PLAYER = 0x27713e8;                  //[Miscellaneous]->LocalPlayer
constexpr uint64_t OFF_ENTITY_LIST = 0x23c2848;                   //[Miscellaneous]->cl_entitylist

constexpr uint64_t OFF_NAME_LIST = 0x8b960c0;                     //[Miscellaneous]->NameList
constexpr uint64_t OFF_NAME_INDEX = 0x38;                         //nameIndex
constexpr uint64_t OFF_GAMEMODE = 0x027a8cf0;                      //[ConVars].mp_gamemode
constexpr long OFF_SQUAD_ID = 0x0334;							  //m_squadID

// HUD
constexpr uint64_t OFF_VIEWRENDER = 0x33e0440;                    //[Miscellaneous]->ViewRender
...
constexpr uint64_t OFF_INATTACK = 0x033e1bf8;                     //[Buttons]->in_attack
...
constexpr uint64_t OFF_LAST_VISIBLE_TIME = 0x1990;          //[RecvTable.DT_BaseCombatCharacter]->m_hudInfo_visibilityTestAlwaysPasses + 0x3
constexpr uint64_t OFF_LAST_AIMEDAT_TIME = 0x1998;    //[RecvTable.DT_BaseCombatCharacter]->m_hudInfo_visibilityTestAlwaysPasses + 0x3 + 0x8
...
// Glow
constexpr uint64_t OFF_GLOW_HIGHLIGHTS = 0x71a3f00;               //HighlightSettings
